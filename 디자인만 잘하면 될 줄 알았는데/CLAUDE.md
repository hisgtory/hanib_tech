...
| 문서 | 설명 |
|------|------|
| [docs/01_철학.md](./docs/01_철학.md) | 프로젝트 비전, 콘텐츠 철학, HSEPC 모델 |
| [docs/02_개발_원칙.md](./docs/02_개발_원칙.md) | 기술 스택, 코드 원칙, Git 컨벤션 |
| [docs/03_프로젝트_구조.md](./docs/03_프로젝트_구조.md) | 디렉토리 구조, API 엔드포인트, 실행 방법 |
| [docs/04_일하는_원칙.md](./docs/04_일하는_원칙.md) | 작업 흐름, 문제 해결, 커뮤니케이션 |
| [docs/05_요청자_특성.md](./docs/05_요청자_특성.md) | 요청 스타일, 선호도, 협업 팁 |
| [docs/06_Claude_컨텍스트.md](./docs/06_Claude_컨텍스트.md) | 세션 시작시 확인, 명령어, 에러 대응 |
